...
const viewSparePartBookingByWid = (req, res) => {
    spareOrders.find({shopid:req.params.id,status:true})
    .populate('userid')
  ...
  const updateSparePartBookingByWid = (req, res) => {
    spareOrders.findByIdAndUpdate({_id:req.params.id},{status:false})
